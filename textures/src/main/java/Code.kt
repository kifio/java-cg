...
class Code : JFrame(TITLE), GLEventListener {
    ...
    override fun init(p0: GLAutoDrawable?) {
        ...
        val brickTexture = loadTexture("brick.jpg")
        texture = brickTexture.textureObject
        setupVertices()
    ...
    private fun setupVertices() {
        ...
        val pyramidTexturePositions = floatArrayOf(
                0f, 0f, 1f, 0f, 0.5f, 1f, 0f, 0f, 1f, 0f, 0.5f, 1f,
                0f, 0f, 1f, 0f, 0.5f, 1f, 0f, 0f, 1f, 0f, 0.5f, 1f,
                0f, 0f, 1f, 1f, 0f, 1f, 1f, 1f, 0f, 0f, 1f, 0f
        )
        ...
        gl.glBindBuffer(GL.GL_ARRAY_BUFFER, vbo[1])
        val textureBuf = Buffers.newDirectFloatBuffer(pyramidTexturePositions)
